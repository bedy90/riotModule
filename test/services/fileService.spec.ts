...
describe('01.02.00 - FileService', () => {
  ...
  it('01.02.01 => Create test folder tree', (done) => {
  ...
  it('01.02.02 => Create multiple test folder tree', (done) => {
    FileService.createFolder(test_Folder);
    let result: boolean = FileService.checkFileExists(test_Folder);
  ...
  it('01.02.03 => Try create folder with invalid name', (done) => {
  ...
  it('01.02.04 => Create an empty test file', (done) => {
  ...
  it('01.02.05 => Create a new text file with content', (done) => {
    try {
      let initialCheck: boolean = FileService.checkFileExists(test_TextFilePath);
  ...
  it('01.02.06 => Trying to write a new text file without filename', (done) => {
  ...
  it('01.02.07 => Create a new JSON file with content', (done) => {
