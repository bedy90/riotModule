...
import { RequestService, ValidationService, RiotGameType, VersionData } from "../../src";
import EnvVars from "../../src/declaration/major/EnvVars";
// import { VersionData } from "../../src/model/DragonModel";
import { join } from "path";
import { ISummonerDTO, IAccountDTO } from "@bedy90/riotentity";
// import { IAccountDTO } from "../../src/entity/Account-v1/AccountDTO";

describe('01.04.00 -  RequestService', () => {
  ...
  it('01.04.00 => (Riot call) Get Summoner info', async () => {
    // Call Riot API
  ...
  it('01.04.01 => (Riot call) Get riot account info', async () => {
    // Call Riot API
    const realRegion : string = ValidationService.convertToRealRegion('NA');
  ...
  it('01.04.02 => (Riot call) Get TFT Summoner info without Token', async () => {
    // Call Riot API
  ...
  it('01.04.03 => (Riot call) Get text file', async () => {
  ...
  it('01.04.04 => (Riot call) Get text file - 404', async () => {
    try {
  ...
  it('01.04.05 => Get dragon version file', async () => {
  ...
  it('01.04.06 => Get text file - 404', async () => {
    try {
  ...
  it('01.04.07 => Download the contents of a file via a remote URL.', async () => {
  ...
  it('01.04.08 => Try downlaod and write a file with a invalid URL. - 403', async () => {
    try {
