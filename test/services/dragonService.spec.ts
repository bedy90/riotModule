...
import { DragonService, ReturnData, FileService, DragonFileName, DragonPath, DragonCulture, DragonFileType  } from '../../src';
import { DragonChampion, DragonFile, DragonVersion, IDragonChampion, CacheService, CacheName  } from '../../src';
...
describe('02.01.00 - DragonService', () => {
  ...
  before(() => {
    ...
    try {
      console.log(`Before Remove DragonFolder : ${DragonPath.dragonFolder}`)
      console.log(`Before Remove TestFolder : ${test_Folder}`)
  ...
  // afterEach
  after(() => {
    console.log(`After Remove DragonFolder : ${DragonPath.dragonFolder}`)
    console.log(`After Remove TestFolder : ${test_Folder}`)
  ...
  it('02.01.01 => Get dragon default folder', (done) => {
  ...
  it('02.01.02 => Get dragon default folder with culture', (done) => {
  ...
  it('02.01.03 => Get dragon default folder with culture and filename', (done) => {
  ...
  it('02.01.04 => Get dragon default folder with culture, filename and subfolder', (done) => {
  ...
  it('02.01.05 => Get dragon default folder with culture and subfolder', (done) => {
  ...
  it('02.01.06 => Get dragon champion file url path', (done) => {
  ...
  it('02.01.07 => Prepare dragon folder tree', (done) => {
  ...
  it('02.01.08 => Download external file', async () => {
    try {
  ...
  it('02.01.09 => Download version list (Dragon)', async () => {
  ...
  it('02.01.10 => Update version list (Dragon)', async () => {
  ...
  it('02.01.11 => Get summary champion info in file by championId', async () => {
  ...
  it('02.01.12 => Get summary champion info by championId without specify a culture (default culture)', async () => {
  ...
  it('02.01.13 => Get summary champion info in file by championName', async () => {
  ...
  it('02.01.14 => Get summary champion info by championName without specify a culture (default culture)', async () => {
  ...
  it('02.01.15 => Get several summary champions info by id', async () => {
  ...
  it('02.01.16 => Get several summary champions info by id (without cache)', async () => {
    const firstChampionInfo: DragonChampion = await DragonService.getChampionInfoById(99, DragonCulture.fr_fr);
    assert.ok(firstChampionInfo);
    assert.isNotNull(firstChampionInfo);
    assert.isDefined(firstChampionInfo);
  ...
  it('02.01.17 => Get several summary champions info by name', async () => {
  ...
  it('02.01.18 => Get several summary champions info by name (without cache)', async () => {
    const firstChampionInfo: DragonChampion = await DragonService.getChampionInfoByName("Lux", DragonCulture.fr_fr);
    assert.ok(firstChampionInfo);
    assert.isNotNull(firstChampionInfo);
    assert.isDefined(firstChampionInfo);
  ...
  it('02.01.19 => Get detailed champion info in file by championId', async () => {
  ...
  it('02.01.20 => Get detailed champion info by championId without specify a culture (default culture)', async () => {
  ...
  it('02.01.21 => Get several detail champions info by name', async () => {
  ...
  it('02.01.22 => Get several detail champions info by name (without cache)', async () => {
    const firstChampionInfo: DragonChampion = await DragonService.getDetailedChampionInfoByName("Lux", DragonCulture.fr_fr);
    assert.ok(firstChampionInfo);
    assert.isNotNull(firstChampionInfo);
    assert.isDefined(firstChampionInfo);
  ...
  // it('02.01.23 => Get champs in cache', async () => { 
