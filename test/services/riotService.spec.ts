...
import { DragonCulture, RiotService, Rotation, ValidationService, FileService, DragonPath } from "../../src";
...
describe('02.02.00 - RiotService', () => {
    ...
    // Scenario
    it('02.01.01 => (MOCK Riot call) Get AccountInfo by PUUID', async () => {
        try {
    ...
    it('02.01.02 => (MOCK Riot call) Get AccountInfo by GameName and TagLine', async () => {
        try {
            let riotService: RiotService = new RiotService();
            let expectedResult: Promise<IAccountDTO> = MockRiotRequest.getAsyncRiotAccount();
    ...
    it('02.01.03 => Get current rotation', async () => {
        // Call Riot API
